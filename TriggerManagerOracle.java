...
import java.util.*;
import java.sql.*;
public class TriggerManagerOracle extends JPanel implements ActionListener
{
//-----------------Khai bao cac bien dung tr2ong chuong trinh--
	...
	ResultSet rss;
//-----------------Ham cau tu-------------------------------
	public TriggerManagerOracle(String username,Connection cons){

		con=cons;
		stSQL = new String("SELECT  TRIGGER_NAME,  TRIGGER_TYPE,  TRIGGERING_EVENT,  DESCRIPTION, TRIGGER_BODY  FROM all_triggers where owner='"+username+"'");
		us=username;
	...
	//	add(jpFind, "North");
		...
		JLabel jlObject =new JLabel("Trigger t\u1EA1i schema "+us );
		jlObject.setIcon(new ImageIcon("icon\\webforms_b.gif"));
...
/*	public static void main(String[] args) 
	{
		...
		TriggerManagerOracle usermanager=new TriggerManagerOracle("SYSTEM");
