...
public class SQL extends JPanel implements ActionListener
{
//-----------------Khai bao cac bien dung tr2ong chuong trinh--

	String stSQL=new String("select USERNAME, USER_ID ,PASSWORD,ACCOUNT_STATUS, DEFAULT_TABLESPACE , TEMPORARY_TABLESPACE from dba_users");
	JTextArea jtaSQL;
...
//-----------------Ham cau tu-------------------------------
	...
	public String getDocumentName() {
		...
		if (m_chooser.showOpenDialog(SQL.this) !=
	...
	public boolean saveFile(boolean saveAs) {
		...
		if (m_chooser.showSaveDialog(SQL.this) !=
		JFileChooser.APPROVE_OPTION)
		return false;
		File f = m_chooser.getSelectedFile();
		if (f == null)
...
//-----------Ham su ly su kien click Edit----------
	...
	if (ae.getActionCommand().equals("B\u1ECF qua")){
					stSQL ="select USERNAME, USER_ID ,PASSWORD,ACCOUNT_STATUS, DEFAULT_TABLESPACE , TEMPORARY_TABLESPACE from dba_users" ;
